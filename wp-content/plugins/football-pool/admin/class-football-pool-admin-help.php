...
<pre class="code-block"><code class="bash">$ wp football-pool calc --force-calculation</code></pre>
		...
		*/
		...
		<p>Assets can be uploaded to the football-pool dir in the WP uploads dir <?php echo FOOTBALLPOOL_UPLOAD_URL; ?>.</p>
		<h4>Minimal data</h4>
		<!--p>
...
add_filter( \'footballpool_print_ranking_ranking\', \'fp_pagination\' );
