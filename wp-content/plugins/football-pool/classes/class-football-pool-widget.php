...
abstract class Football_Pool_Widget extends WP_Widget {
	...
	public function __construct( $classname, $widgetname, $description ) {
		...
		$description = __( 'Football pool plugin', 'football-pool' ) . ' &raquo; ' . __( $description, 'football-pool' );
	...
	public function widget( $args, $instance ) {
		...
		if ( isset( $instance['title'] ) )
			$title = apply_filters( 'widget_title', __( $instance['title'], 'football-pool' ), $instance, $this->id_base );
		else
			$title = '';
