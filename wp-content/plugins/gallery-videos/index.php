...
/*
	...
	Description: Video Gallery created for those who realy appreciate the beauty and taste. You can display your videos in high quality and best design
	Version: 1.2.6
	Author: Total-Soft
...
*/		
	...
	function TotalSoft_VGallery_Admin_Menu(){
		$complete_url = wp_nonce_url( $bare_url, 'edit-menu_'.$comment_id, 'TS_VGallery_Nonce' );
	...
	function Total_Soft_VGallery_settings_link($links)
	{
		...
		$edit = '<a href="plugin-editor.php?file=gallery-videos/index.php"> Edit </a>';
