...
;(function ($, window) {
	...
	function build(e) {
		if (typeof data.$boxer === "undefined") {
			...
			var $target = $(this),
				...
				isVideo	= ( source.indexOf("youtube.com/embed") > -1 || source.indexOf("player.vimeo.com/video") > -1 || source.indexOf("wistia") > -1 ),
	...
	function loadVideo(source) {
		...
		data.$video = $('<iframe class="boxer-video" seamless="seamless" frameborder="0" allowfullscreen/>');
