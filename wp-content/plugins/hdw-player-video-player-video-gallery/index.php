...
function hwplayer_plugin_js() {    
	if( !is_admin()){    
		...
		wp_enqueue_style( 'hdwstyle', get_hdwplayer_directory_uri() . '/css/html5.hdwstyles.css');
		
		$html5maj = get_hdwplayer_directory_uri() . '/js/';
		wp_register_script( 'hdwmaj', $html5maj . 'majhdwplayer.js', 'jquery', false );
		wp_enqueue_script( 'hdwmaj' );
		
		$html5hdw = get_hdwplayer_directory_uri() . '/js/';
		wp_register_script( 'hdwhtml', $html5hdw . 'html5.hdwplayer.js', 'jquery', false );
